...
import com.example.sairamkrishna.instagblogapp.CommentsActivity;
import com.example.sairamkrishna.instagblogapp.Model.Post;
import com.example.sairamkrishna.instagblogapp.Model.PostId;
            ...
            public void onClick(View v) {
                firestore.collection("Posts/"+postId+"/Likes").document(currentUserId).get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if(!task.getResult().exists())  //data not exists then initialized the map
                        {
                        ...
                        else
                        {
                            ...
                            //if the currentUser click the like btn again then it deleted
                        }
                    }
                });
            }
        });
        //Color of the like btn change
        ...
        if(currentUserId.equals(post.getUser()))
        {
            ...
            holder.deleteBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    alert.setTitle("Delete!!").setMessage("Want to delete?")
